...
class Auth
{
	public static function authenticate($row,$permisos)
	{
	...
	public static function getPermisosHeader(){
		return $_SESSION['PERMISOS'];
	}

	public static function getUser(){
		error_log("USUARIOS -> ". json_encode($_SESSION['USER']));
		return $_SESSION['USER'];
	}

	public static function getIdUser()
	{
		error_log("USUARIOS id -> " . json_encode($_SESSION['USER']));
		return $_SESSION['USER']["IdUsuario"];
	}
